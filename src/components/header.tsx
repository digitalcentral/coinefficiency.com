...
import { AnnotationIcon, ChatAlt2Icon, InboxIcon, QuestionMarkCircleIcon, XIcon } from "@heroicons/react/outline"
    ...
    <div className="bg-white">
      <header>
        <Popover className="relative bg-white">
          <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-center md:space-x-10 lg:px-8">
            <div className="flex  items-center lg:w-0 lg:flex-1">
              <span className="sr-only">CoinEfficiency</span>
              <Link to="/">
                <StaticImage src="../images/coinefficiency-logo.png" alt="CoinEfficiency" height={80} />
              </Link>
              <div className="ml-3 text-3xl font-medium text-gray-900 flex-shrink-0">CoinEfficiency</div>
            </div>
